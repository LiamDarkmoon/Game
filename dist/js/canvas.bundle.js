...
var Player = /*#__PURE__*/function () {
  ...
  _createClass(Player, [{
    ...
    value: function update() {
      this.frames++;
      if (this.frames > 59 && this.currentSprite === this.sprites.stand.right || this.frames > 59 && this.currentSprite === this.sprites.stand.left) this.frames = 0;else if (this.frames > 28 && this.currentSprite === this.sprites.run.right || this.frames > 28 && this.currentSprite === this.sprites.run.left) this.frames = 0;
      this.draw();
...
function init() {
  ...
  platforms = [new Platform({
    ...
    x: platformImage.width * 4 + 300 - 2 + platformImage.width - platformSmallTallImage.width / 2,
    y: 170,
    image: platformSmallTallImage
  }), new Platform({
    ...
    x: platformImage.width * 10 + 1100 - 2 + platformImage.width - platformSmallTallImage.width,
    y: 270,
    image: platformSmallTallImage
  }), new Platform({
    x: -1,
...
function animate() {
  ...
  if (keys.right.pressed && lasttKey === "right" && player.currentSprite !== player.sprites.run.right) {
    player.frames = 1;
    player.currentSprite = player.sprites.run.right;
    player.currentCropWidth = player.sprites.run.cropWidth;
    player.width = player.sprites.run.width;
  } else if (keys.left.pressed && lasttKey === "left" && player.currentSprite !== player.sprites.run.left) {
    player.frames = 1;
    player.currentSprite = player.sprites.run.left;
    player.currentCropWidth = player.sprites.run.cropWidth;
    player.width = player.sprites.run.width;
  } else if (!keys.left.pressed && lasttKey === "left" && player.currentSprite !== player.sprites.stand.left) {
    player.frames = 1;
    player.currentSprite = player.sprites.stand.left;
    player.currentCropWidth = player.sprites.stand.cropWidth;
    player.width = player.sprites.stand.width;
  } else if (!keys.right.pressed && lasttKey === "right" && player.currentSprite !== player.sprites.stand.right) {
    player.frames = 1;
